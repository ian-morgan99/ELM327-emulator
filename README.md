...
# Testing AndrOBD and Mobile Applications

*ELM327-emulator* is an excellent test harness for developing and testing mobile OBD-II applications like [AndrOBD](https://github.com/fr3ts0n/AndrOBD) without requiring a physical vehicle or OBD-II adapter. The emulator fully supports simulating wireless OBDII adapters including v-link WiFi adapters and Bluetooth adapters.

## Quick Start for AndrOBD Testing

**WiFi/Network Testing (Recommended):**

```bash
# Start emulator with WiFi interface on standard port
python3 -m elm -s car -n 35000
```

Then configure AndrOBD:
- Connection type: Network (WiFi)
- IP Address: Your computer's IP address
- Port: 35000

**Bluetooth Testing:**

Follow the Bluetooth setup instructions in the [Testing AndrOBD Guide](TESTING_ANDROBD.md).

**Quick Start Scripts:**

Use the provided example scripts for easy setup:

```bash
# Linux/macOS
./examples/test_androbd_wifi.sh

# Windows
examples\test_androbd_wifi.bat

# Python with dynamic simulation
python3 examples/test_androbd_dynamic.py
```

For comprehensive instructions including:
- Detailed WiFi and Bluetooth setup for Linux, Windows, and macOS
- Dynamic data simulation
- Testing workflows
- Troubleshooting guide
- Example scripts and automation

See the **[Testing AndrOBD Applications Guide](TESTING_ANDROBD.md)**.
